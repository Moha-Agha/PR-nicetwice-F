...
export const cardsData = [
  ...
  },
  {
    ...
    image: 'https://source.unsplash.com/collection/',
    tags: ['UI', 'UX'],
    title: '100 Things a UX/UI Designer Should Know',
    share: '',
    likes: '10K',
    views: '155K',
    youtube: '',
  ...
  },
  {
    ...
    title: 'Die Live-Vorschau von WordPress verknüpft Backend und Frontend',
    share: '',
    likes: '60K',
    views: '77K',
    youtube: '',
...
export const sectionsData = [
  ...
  },
  {
    ...
    name: 'ux-design',
    title: 'UX Design',
    description: 'User experience design is the process of supporting user behavior through usability, usefulness, and desirability provided in the interaction with a product.',
    articleNumber: '05'
  },
  {
    id: 4,
    name: 'branding',
    title: 'Branding',
    description: 'A brand is a name, term, design, symbol or any other feature that identifies one seller good or service as distinct from those of other sellers.',
    articleNumber: '02'
  },
  {
    id: 5,
